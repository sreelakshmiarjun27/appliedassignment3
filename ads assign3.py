...
#print(canada)
    #canada.dropna()
#canada["forest sq"] = dt["INDIA"]
#canada["CO2"] = sdt["INDIA"]
#kmean = cluster.KMeans(n_clusters=2).fit(canada)
#label = kmean.labels_
#plt.scatter(canada["co2_liquid"],canada["co2_solid"],c=label,cmap="jet")
...
label = kmean.labels_
plt.scatter(sdt["COLOMBIA"],sdt["INDIA"],c=label,cmap="jet")
plt.title("INDIA VS COLOMBIA(CO2 EMISSION LIQUID)")
"""
finding centroids
"""
